...
const CarrerTools = () => {
  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-8 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div data-aos="fade-right" data-aos-duration="1000">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-16 pt-10 pb-10">
            {services.map((service, index) => (
              ...
              >
                <div className="p-6 text-center">
                  <img src={service.image} alt={service.title} className="w-24 h-32 mx-auto mb-4 object-contain" />
