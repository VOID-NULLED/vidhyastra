...
const Banner = () => {
  return (
    <div className="bg-purple-500 text-white rounded-lg overflow-hidden h-auto md:h-[23vw] flex items-center justify-center">
      <div className="container mx-auto px-4 py-6 md:py-8 lg:py-10">
        <div className="flex flex-col md:flex-row items-center justify-center p-4 md:p-6">
          <div className="mb-6 md:mb-0 md:mr-6 md:w-1/2 text-center md:text-left p-8">
